...
{
    public partial class HelpFormPeregonshiki : Form
    {
        public HelpFormPeregonshiki()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand command = new SqlCommand("INSERT INTO autosalon.dbo.Поставщики (ФИО, Паспорт_данные) VALUES (@textBox1, @textBox2)", con);
            con.Open();
