...
{
    public partial class HelpFormPokypatel : Form
    {
        public HelpFormPokypatel()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand command = new SqlCommand("INSERT INTO autosalon.dbo.Покупатели (ФИО, Адрес, Паспортные_данные) VALUES (@textBox1, @textBox2,@textBox3)", con);
            con.Open();
